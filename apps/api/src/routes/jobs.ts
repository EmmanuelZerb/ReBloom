 ...
 * POST /api/webhooks/replicate - Webhook Replicate
 */
 ...
 */
jobs.post('/webhooks/replicate', zValidator('json', replicateWebhookSchema), async (c) => {
  const payload = c.req.valid('json');

  logger.info({ predictionId: payload.id, status: payload.status }, 'Replicate webhook received');
