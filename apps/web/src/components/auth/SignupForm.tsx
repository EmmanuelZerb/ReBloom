...
export function SignupForm({ onSuccess, onSwitchToLogin }: SignupFormProps) {
  ...
  if (isSuccess) {
    return (
      <div className="w-full max-w-md mx-auto">
        <div className="bg-white rounded-2xl shadow-[0_4px_40px_-12px_rgba(0,0,0,0.12)] p-8 border border-stone-100 text-center">
  ...
  return (
    <div className="w-full max-w-md mx-auto">
      <div className="bg-white rounded-2xl shadow-[0_4px_40px_-12px_rgba(0,0,0,0.12)] p-8 border border-stone-100">
        {/* Header */}
        <div className="text-center mb-8">
          <a href="/" className="inline-block text-xl font-semibold text-stone-900 mb-4">
            ReBloom
          </a>
        ...
        {error && (
          <div className="mb-6 p-4 bg-[#FFF5F3] border border-[#FFE8E3] rounded-xl text-[#FF7F66] text-sm">
            {error}
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <button
            ...
            className="w-full py-3 px-4 bg-stone-900 hover:bg-stone-800 text-white font-medium rounded-xl transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
          >
            {isSubmitting ? (
              <>
